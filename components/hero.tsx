      ...
      <div className="container mx-auto px-6 flex flex-col justify-between items-center pb-4">
        <div className="flex flex-col">
          ...
          <p className="md:text-3xl my-6 text-green-500 text-center">
            Hi, I&#x27;m{" "}
            <Link
              href="https://samsulmuarrif.my.id"
              className=" underline underline-offset-8 hover:text-sky-500"
            >
              Samsul Muarrif
            </Link>
          </p>
          <h4 className="max-w-3xl lg:text-2xl leading-10 mx-auto dark:text-white text-zinc-600 text-center py-2">
            Code that crafts products, shapes brands, and elevates experiences.
          </h4>
